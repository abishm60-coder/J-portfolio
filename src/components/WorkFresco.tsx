      ...
      <div className="work-fresco-content">
        ...
        <div className="fresco-html-section">
          <div className="fresco-section-header">
            ...
            <div className="fresco-sub-header">
              <h4 className="fresco-sub-title">developer handoff</h4>
              <p className="fresco-sub-desc">
                the final designs were delivered with a comprehensive design system, including component documentation, responsive layouts, and interaction specifications to ensure smooth development implementation.
              </p>
            </div>
          </div>
          <div className="fresco-image-container">
